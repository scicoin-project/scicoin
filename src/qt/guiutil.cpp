...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Scicoin.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for Scicoin.lnk
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Scicoin-Qt") + " " + tr("version") + " " +
